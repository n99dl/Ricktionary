...
//        testArea.replaceText("Oh read");
//        testArea.setStyleClass(0, 6, "testA");
//        inlineText.replaceText(" Oh hod ");
        int i = 0;
...
//                        item.get(0).getOnMouseClicked();
    ...
    void playWord(MouseEvent event) throws MalformedURLException {
        File f = new File("src/main/resources/output.mp3");
    ...
    private void setMeaning(String[] textMeaning){
